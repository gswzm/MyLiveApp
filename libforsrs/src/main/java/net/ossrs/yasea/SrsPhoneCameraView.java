 ...
 */
public class SrsPhoneCameraView extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    public SrsPhoneCameraView(Context context) {
        this(context, null);
    }

    public SrsPhoneCameraView(Context context, AttributeSet attrs) {
        super(context, attrs);
