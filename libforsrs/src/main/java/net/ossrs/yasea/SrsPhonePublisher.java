 ...
 */
public class SrsPhonePublisher {
    ...
    private SrsPhoneCameraView mCameraView;
    ...
    public SrsPhonePublisher(SrsPhoneCameraView view) {
        mCameraView = view;
        mCameraView.setPreviewCallback(new SrsPhoneCameraView.PreviewCallback() {
            @Override
